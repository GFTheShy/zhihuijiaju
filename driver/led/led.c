...
void led_func(uint16_t light)
{
	...
	else if(light<1500 &&light>=1000)	TIM_SetCompare1( TIM1,  900);
	else if(light<2800 &&light>=1500)	TIM_SetCompare1( TIM1,  500);
	else if(light<3000 &&light>=2800)	TIM_SetCompare1( TIM1,  100);
