...
{
	if(light<1000)	TIM_SetCompare1( TIM1,  0);
	else if(light<1500 &&light>=1000)	TIM_SetCompare1( TIM1,  100);
	else if(light<2000 &&light>=1500)	TIM_SetCompare1( TIM1,  400);
	else if(light<3000 &&light>=2000)	TIM_SetCompare1( TIM1,  600);
	else if(light>=3000)	TIM_SetCompare1( TIM1,  800);
}
