...
void USART2_IRQHandler(void)
{
	...
	if(USART_GetITStatus(USART2,USART_IT_IDLE))
	{
		...
		if(strstr((const char *)USART2_BUF,"LED1ON"))
		{
				led_open(1);
				led1_flag=1;
				OLED_Clear();
		...
		else if(strstr((const char *)USART2_BUF,"LED1OFF"))
		{
				led_close(1);
				led1_flag=0;
				OLED_Clear();
		...
		else if(strstr((const char *)USART2_BUF,"BEEPON"))
		{
							beep_open();
							beep_flag=1;
							OLED_Clear();
		...
		else if(strstr((const char *)USART2_BUF,"BEEPOFF"))
		{
			beep_close();
							beep_flag=0;
							OLED_Clear();
		...
		else if(strstr((const char *)USART2_BUF,"FANON"))
		{
			fan_open();
			fan_flag=1;
			fan_mux=1;
		...
		else if(strstr((const char *)USART2_BUF,"FANOFF"))
		{
			fan_close();
			fan_flag=0;	
			fan_mux=1;
