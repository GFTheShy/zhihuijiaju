...
{
	OLED_Clear();
	OLED_ShowChinese(36,0,4,16,1);//李
	OLED_ShowChinese(50,0,5,16,1);//陈
	OLED_ShowChinese(64,0,6,16,1);//刚
	
	OLED_ShowString(8,16,"SMART FAMILY",16,1);
	OLED_Refresh();
...
void oled_wait(void)
{
	OLED_ShowChinese(8,32,7,16,1);   //智
	OLED_ShowChinese(22,32,8,16,1);  //慧
	OLED_ShowChinese(36,32,9,16,1);  //家
	OLED_ShowChinese(50,32,10,16,1);  //居
	OLED_ShowChinese(64,32,11,16,1); //控
	OLED_ShowChinese(80,32,12,16,1); //制
	OLED_ShowChinese(94,32,13,16,1); //系
	OLED_ShowChinese(108,32,14,16,1);//统
	OLED_Refresh();
}
char text[20];
